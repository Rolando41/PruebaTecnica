...
namespace PruebaTecnica_AccesoDatos.SQL
{
    public class DataSql
    {
        ...
        public IEnumerable<VehiculoDTO> obtenerVehiculosSinServicios()
        {
        ...
        //Agregar vehiculo
        public void guardarVehiculo(Resgistrar model)
        {
        ...
        public IEnumerable<VehiculoDTO> obtenerListaVheiculoPorServicio(int idServicio)
        {
        ...
        //Mostrar Servicios
        public IEnumerable<ServiciosDTO> obtenerServicios()
        {
